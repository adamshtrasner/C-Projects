 ...
 * @param spreader_detector the spreader detector we want to add the person to.
 * @param person the person we want to add to the spreader detector.
 ...
 * @param spreader_detector the spreader detector we want to add the meeting to.
